...
- **Factores de conversión**: la IA ayudó a juntar las tablas de las 8 categorías, que después verificamos a mano contra fuentes.
- **Dónde la corregimos**: el parser de lenguaje natural lo propuso con una librería externa que daba problemas en el bundle, así que la descartamos y reescribimos el conversor de palabras a números a mano. Las decisiones de arquitectura (diseño data-driven, no usar store global) fueron del equipo.
- **Documentación**: este README fue generado con apoyo de IA.
